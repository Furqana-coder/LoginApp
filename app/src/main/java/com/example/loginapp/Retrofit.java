...
import com.example.loginapp.api.Client;
import com.example.loginapp.api.Service;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener(){
            ...
            public void onRefresh(){
                loadJSON();
                Toast.makeText(Retrofit.this, "Github Users Refreshed", Toast.LENGTH_SHORT).show();
            }
        });
    }
